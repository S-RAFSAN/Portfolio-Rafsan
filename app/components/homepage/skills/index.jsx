...
import { skillsData, skillsByCategory } from "@/utils/data/skills";
    ...
    <div id="skills" className="relative z-50 my-8 lg:my-20 max-w-[1400px] mx-auto px-4 lg:px-10 overflow-hidden select-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-stretch">
        ...
        <div className="lg:col-span-7 relative group rounded-3xl overflow-hidden">
          ...
          <div className="bg-[#0d1224]/90 border border-white/10 backdrop-blur-3xl h-full flex flex-col min-h-[510px]">
            ...
            <div className="p-6 lg:p-8 flex-grow flex flex-col relative overflow-hidden">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {(skillsByCategory[categories[activeTab].title] ?? []).map((skill, idx) => (
                    <div key={`${skill}-${idx}`} className="flex items-center gap-3 group/skill">
