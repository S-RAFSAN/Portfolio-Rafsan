          ...
          <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2">
            ...
            <motion.div variants={itemVars} className="my-6 flex items-center gap-5">
              {[
                ...
                {
                  Icon: SiDevdotto,
                  link: personalData.devUsername
                    ? `https://dev.to/${personalData.devUsername}`
                    : "",
                  size: 40,
                },
              ...
              <div className="relative bg-[#0d1224]/90 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl p-4 overflow-hidden">
                ...
                <div className="overflow-x-auto">
                  <code className="font-mono text-xs md:text-sm text-gray-200 leading-relaxed">
                    ...
                    <div className="ml-4"><span className="text-white">name:</span> <span className="text-amber-300">'Sayduzzaman Rafsan',</span></div>
                    <div className="ml-4"><span className="text-white">builds:</span> <span className="text-gray-400">[</span></div>
                    <div className="ml-8 text-amber-300">'Websites', 'WebApps', 'Scalable-APIs'</div>
                    <div className="ml-4 text-gray-400">],</div>
                    <div className="ml-4">
                      <span className="text-white">expertise:</span> <span className="text-gray-400">[</span>
                      <div className="ml-8 text-amber-300">'Full-Stack Engineering','Architecture & System Design','API Integration','Database Management','UI/UX Design'</div>
                      <div className="ml-4 text-gray-400">],</div>
                    </div>
                    <div className="ml-4">
                      ...
                      <div className="ml-8">
                        ...
                        'Next.js', 'TypeScript', 'Node.js', 'MongoDB', 'Tailwind', 'Github'
                        </span>
