...
function AboutSection() {
  ...
  return (
    <div
      id="about"
      className="relative my-12 lg:my-24 py-12 overflow-hidden min-h-screen flex items-center"
    >
            ...
            <div className="relative flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:gap-10">
              ...
              >
                ...
                <div className="absolute -bottom-3 -left-3 lg:-bottom-4 lg:-left-4 bg-[#0d1224] border border-[#16f2b3]/30 p-3 lg:p-4 rounded-xl lg:rounded-2xl shadow-2xl z-20">
                  <p className="text-[#16f2b3] font-black text-xl lg:text-lg leading-none uppercase">
                    Months of
                  </p>
                  <p className="text-white text-[7px] lg:text-[8px] font-bold uppercase tracking-widest mt-0.5 lg:mt-1 opacity-80">
                    Industry Experience
                  </p>
                </div>
              </div>
