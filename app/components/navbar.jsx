...
function MobileMenu({ mainLinks, moreLinks, checkActive }) {
  ...
  return (
    <div className="md:hidden relative">
      ...
      >
        <span
          className={`h-[2px] bg-white rounded transition-all duration-300 ${open ? "rotate-45 translate-y-[8px]" : ""}`}
        ></span>
        <span
          className={`h-[2px] bg-white rounded transition-all duration-300 ${open ? "opacity-0" : ""}`}
        ></span>
        <span
          className={`h-[2px] bg-white rounded transition-all duration-300 ${open ? "-rotate-45 -translate-y-[8px]" : ""}`}
        ></span>
